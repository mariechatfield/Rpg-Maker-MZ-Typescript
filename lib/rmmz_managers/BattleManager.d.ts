...
declare namespace BattleManager {
  ...
  export function setEventCallback(
    callback: (result: BattleManager.Result) => void,
  ): void;
  ...
  export function displayBattlerStatus(
  ...
  export function invokeNormalAction(
    subject: Game_Battler,
    target: Game_Battler,
  ): void;
  export function invokeCounterAttack(
    subject: Game_Battler,
    target: Game_Battler,
  ): void;
  export function invokeMagicReflection(
    subject: Game_Battler,
    target: Game_Battler,
  ): void;
