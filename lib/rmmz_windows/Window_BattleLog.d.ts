...
declare class Window_BattleLog extends Window_Base {
  ...
  public performSubstitute(
    substitute: Game_Battler,
    target: Game_Battler,
  ): void;
  ...
  public showAnimation(
    subject: Game_BattlerBase,
    targets: Game_BattlerBase[],
    animationId: number,
  ): void;
  public showAttackAnimation(
    subject: Game_BattlerBase,
    targets: Game_BattlerBase[],
  ): void;
  ...
  public displaySubstitute(
    substitute: Game_Battler,
    target: Game_Battler,
  ): void;
  public displayActionResults(
    subject: Game_Battler,
