...
declare class Window_NameEdit
  implements Omit<Window_StatusBase, "name" | keyof Window>
{
  ...
  public processControlCharacter(
    textState: Window_Base.TextState,
    c: string,
  ): void;
  ...
  public drawItemName(
    item: { iconIndex: number; name: string; description: string },
    x: number,
    y: number,
    width: number,
  ): void;
